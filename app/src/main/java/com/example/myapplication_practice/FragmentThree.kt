...
class FragmentThree : Fragment(){
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.activity_abroad_page,container,false)
        val travelList = ArrayList<Travel>()
        for (i in 0 until 10) {
            travelList.add(Travel(R.drawable.italy, "Italy" + i))
        }
        recyclerView1 = rootView.findViewById(R.id.abroad_travel_container)as RecyclerView
